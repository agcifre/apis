...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tns="https://www.aviq.be" xmlns:com="http://soa.spw.wallonie.be/data/common/common/v3" xmlns:id="http://soa.spw.wallonie.be/common/identification/v1" xmlns:msg="http://soa.spw.wallonie.be/services/handiAVIQ/messages/v1" xmlns:av="http://kszbcss.fgov.be/types/Handi/aviq/v1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	...
	<xsl:template match="/">
		<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
			<soapenv:Header/>
			<soapenv:Body>
				<xsl:element name="tns:consultFilesByDate">
					<xsl:element name="tns:consultFilesByDateRequest">
						...
						<xsl:element name="msg:request">
							...
							<xsl:element name="av:referenceDate"><xsl:value-of select="$operationNode/*[local-name()='request']/*[local-name()='referenceDate']"/>T00:00:00.000Z</xsl:element>
