...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:han="http://soa.spw.wallonie.be/services/handiAVIQ/messages/v1" xmlns:cod="http://soa.spw.wallonie.be/data/common/code/v4" xmlns:err="http://soa.spw.wallonie.be/data/common/error/v4" xmlns:resp="http://soa.spw.wallonie.be/data/common/response/v1">
	...
	<xsl:variable name="consultFilesByDateResponse" select="//*[local-name()='consultFilesByDateResponse']"/>	
	<xsl:variable name="status" select="$consultFilesByDateResponse/*[local-name()='consultFilesByDateResult']/*[local-name()='fileByDate']/*[local-name()='status']"/>	
	<xsl:variable name="fileByDate" select="$consultFilesByDateResponse/*[local-name()='consultFilesByDateResult']/*[local-name()='fileByDate']"/>
					...
					<xsl:choose>
						...
						<xsl:when test="$status//*[local-name()='value']">
							...
							<xsl:if test="((($status/*[local-name()='value']!='NO_RESULT' or ($status/*[local-name()='value']='2'))  and ($status/*[local-name()='value']!='NO_DATA_FOUND' or ($status/*[local-name()='value']='1'))) or $status/*[local-name()='value']='INCOMPLETE_DATA')">
								<han:fileByDate>
									<informationCustomer>
										<ticket><xsl:value-of select="$fileByDate/*[local-name()='informationCustomer']/*[local-name()='ticket']"/></ticket>
										<timestampSent><xsl:value-of select="$fileByDate/*[local-name()='informationCustomer']/*[local-name()='timestampSent']"/></timestampSent>
										<customerIdentification>
											<xsl:choose>
												<xsl:when test="$fileByDate/*[local-name()='informationCustomer']/*[local-name()='customerIdentification']/*[local-name()='CbeNumber']">
													<cbeNumber><xsl:value-of select="$fileByDate/*[local-name()='informationCustomer']/*[local-name()='customerIdentification']/*[local-name()='CbeNumber']"/></cbeNumber>
												</xsl:when>
												<xsl:otherwise>
													<sector><xsl:value-of select="$fileByDate/*[local-name()='informationCustomer']/*[local-name()='customerIdentification']/*[local-name()='Sector']"/></sector>
													<institution><xsl:value-of select="$fileByDate/*[local-name()='informationCustomer']/*[local-name()='customerIdentification']/*[local-name()='Institution']"/></institution>
												</xsl:otherwise>
											</xsl:choose>
										</customerIdentification>
									</informationCustomer>
									<informationSupplier>
										<ticket><xsl:value-of select="$fileByDate/*[local-name()='informationSupplier']/*[local-name()='ticket']"/></ticket>
										<timestampReceive><xsl:value-of select="$fileByDate/*[local-name()='informationSupplier']/*[local-name()='timestampReceive']"/></timestampReceive>
										<timestampReply><xsl:value-of select="$fileByDate/*[local-name()='informationSupplier']/*[local-name()='timestampReply']"/></timestampReply>
										<supplierIdentification>
											<xsl:choose>
												<xsl:when test="$fileByDate/*[local-name()='informationSupplier']/*[local-name()='supplierIdentification']/*[local-name()='CbeNumber']">
													<cbeNumber><xsl:value-of select="$fileByDate/*[local-name()='informationSupplier']/*[local-name()='supplierIdentification']/*[local-name()='CbeNumber']"/></cbeNumber>
												</xsl:when>
												<xsl:otherwise>
													<sector><xsl:value-of select="$fileByDate/*[local-name()='informationSupplier']/*[local-name()='supplierIdentification']/*[local-name()='Sector']"/></sector>
													<institution><xsl:value-of select="$fileByDate/*[local-name()='informationSupplier']/*[local-name()='supplierIdentification']/*[local-name()='Institution']"/></institution>
												</xsl:otherwise>
											</xsl:choose>
										</supplierIdentification>
									</informationSupplier>
									<criteria>
										<ssin><xsl:value-of select="$fileByDate/*[local-name()='criteria']/*[local-name()='ssin']"/></ssin>
										<referenceDate><xsl:value-of select="substring-before(string($fileByDate/*[local-name()='criteria']/*[local-name()='referenceDate']),'T')"/></referenceDate>
										<parts>
											<evolutionOfRequest><xsl:value-of select="$fileByDate/*[local-name()='criteria']/*[local-name()='parts']/*[local-name()='evolutionOfRequest']"/></evolutionOfRequest>
											<handicapRecognitions><xsl:value-of select="$fileByDate/*[local-name()='criteria']/*[local-name()='parts']/*[local-name()='handicapRecognitions']"/></handicapRecognitions>
										</parts>
									</criteria>
									<status>
										<value><xsl:value-of select="$fileByDate/*[local-name()='status']/*[local-name()='value']"/></value>
										<xsl:choose>
											<xsl:when test="$fileByDate/*[local-name()='status']/*[local-name()='value'] = 'DATA_FOUND'"><code>SOA0000000</code></xsl:when>
											<xsl:when test="$fileByDate/*[local-name()='status']/*[local-name()='value'] = 'NO_DATA_FOUND'"><code>SOA0000001</code></xsl:when>
											<xsl:otherwise><code>SOA5100000</code></xsl:otherwise>
										</xsl:choose>
									</status>
									<xsl:if test="$fileByDate/*[local-name()='result']/*[local-name()='ssin'] !=' '">
										<result>
											<ssin><xsl:value-of select="$fileByDate/*[local-name()='result']/*[local-name()='ssin']"/></ssin>
											<file>
												<xsl:if test="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest'] != ' ' ">
													<evolutionOfRequest>
														<legislation><xsl:value-of select="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='legislation']"/></legislation>
														<xsl:if test="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='requestDate'] != ' ' ">
															<requestDate>
																<xsl:value-of select="substring-before(string($fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='requestDate']),'T')"/>
															</requestDate>
														</xsl:if>
														<administrativePendingRequest>
															<xsl:value-of select="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='administrativePendingRequest']"/>
														</administrativePendingRequest>
														<handicapRecognitionPending>
															<xsl:value-of select="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='handicapRecognitionPending']"/>
														</handicapRecognitionPending>
														<xsl:if test="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='fileCompletionDate'] != ' '">
															<fileCompletionDate>
																<xsl:value-of select="substring-before(string($fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='fileCompletionDate']),'T')"/>
															</fileCompletionDate>
														</xsl:if>
														<appeal><xsl:value-of select="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='evolutionOfRequest']/*[local-name()='appeal']"/></appeal>
													</evolutionOfRequest>
												</xsl:if>
												<xsl:if test="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='handicapRecognition'] != ' '">
													<handicapRecognitions>
														<xsl:for-each select="$fileByDate/*[local-name()='result']/*[local-name()='file']/*[local-name()='handicapRecognition']/*[local-name()='HandicapRecognitionType']">
															<handicapRecognition>
																<recognitionStatus>
																	<dateOfDecision>
